...
(base) pratyushsinghrathore@PRATYUSHs-MacBook GitForge % git restore --source=HEAD docs/README.md
(base) pratyushsinghrathore@PRATYUSHs-MacBook GitForge % cat docs/README.md
# GitForge Documentation
